...
// (on_created()/on_removed()) rather than emitted as a Record -- this is the
// attribution mechanism itself, not a telemetry source.
...
// Fills `out` from `e`. Returns false for an event type this watcher does not
